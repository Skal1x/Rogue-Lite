stats[0] = "MP with Brim";		//Name
stats[1] = 2;		//Type of Gun | 0 = No Gun; 1 = Pistol; 2 = MP; 3 = PDW; 4 = AR; 5 = Sniper; 6 = Shotgun; 7 = LMG;
stats[2] = 14;		//Magazine Capacity
stats[3] = 14;		//Current Ammo In Clip
stats[4] = 140;		//Reserve Ammo
stats[5] = 3;		//Spread
