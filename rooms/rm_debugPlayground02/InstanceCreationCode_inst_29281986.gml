...
stats[5] = 30;		//Spread
stats[6] = 30;		//Fire Rate
stats[7] = 2;		//Fire Mode | 0 = Full-Auto; 1 = Burst; 2 = Semi-Auto; 3 = Single-Shoit Reload (Pump/Bolt-Action);
stats[8] = 0;		//Amount of Shots per Burst
stats[9] = 0;		//Shots remaining in current Burst
stats[10] = 1;		//Amount of Pellets per Shot
stats[11] = 15;		//Damage
stats[12] = 12;		//Bullet Speed
stats[13] = 350;		//Bullet Range
