stats[0] = "Burst Pistol";		//Name
stats[1] = 1;		//Type of Gun | 0 = No Gun; 1 = Pistol; 2 = MP; 3 = PDW; 4 = AR; 5 = Sniper; 6 = Shotgun; 7 = LMG;
stats[2] = 18;		//Magazine Capacity
stats[3] = 18;		//Current Ammo In Clip
stats[4] = 180;		//Reserve Ammo
stats[5] = 2.5;		//Spread
stats[6] = 16;		//Fire Rate
stats[7] = 1;		//Fire Mode | 0 = Full-Auto; 1 = Burst; 2 = Semi-Auto; 3 = Single-Shoit Reload (Pump/Bolt-Action);
stats[8] = 3;		//Amount of Shots per Burst
stats[9] = 0;		//Shots remaining in current Burst
stats[10] = 1;		//Amount of Pellets per Shot
stats[11] = 10;		//Damage
stats[12] = 7;		//Bullet Speed
stats[13] = 260;		//Bullet Range
stats[14] = 1;		//Bullet Type
