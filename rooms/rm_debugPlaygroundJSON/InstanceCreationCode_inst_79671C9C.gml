//Set Stats
stats[0] = "Faster Peng";		//Name
stats[1] = 2;		//Type of Gun | 0 = No Gun; 1 = Pistol; 2 = MP; 3 = PDW; 4 = AR; 5 = Sniper; 6 = Shotgun; 7 = LMG;
stats[2] = 50;		//Magazine Capacity
stats[3] = 50;		//Current Ammo In Clip
stats[4] = 500;		//Reserve Ammo
stats[5] = 4;		//Spread
stats[6] = 1;		//Fire Rate
...
stats[11] = 7;		//Damage
stats[12] = 10;		//Bullet Speed
stats[13] = 150;		//Bullet Range
stats[14] = 0;		//Bullet Type
