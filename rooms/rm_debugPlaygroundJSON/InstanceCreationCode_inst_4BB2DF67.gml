stats[0] = "Filthy Pyro Main";		//Name
stats[1] = 2;		//Type of Gun | 0 = No Gun; 1 = Pistol; 2 = MP; 3 = PDW; 4 = AR; 5 = Sniper; 6 = Shotgun; 7 = LMG;
stats[2] = 16;		//Magazine Capacity
stats[3] = 16;		//Current Ammo In Clip
stats[4] = 160;		//Reserve Ammo
stats[5] = 4;		//Spread
stats[6] = 20;		//Fire Rate
...
stats[11] = 10;		//Damage
stats[12] = 6;		//Bullet Speed
stats[13] = 200;		//Bullet Range
stats[14] = 4;		//Bullet Type
